...
fun main(){
    var tp = taxiPark(0..6, 0..9,
        ...
        trip(1, listOf(0,2,5), duration = 15, distance = 28.0),
        ...
        trip(1, listOf(2,3), duration = 16, distance = 23.0),
    ...
    println("Frequent Passenger test  ${tp.findFrequentPass(Driver("D-1"))}")
}
